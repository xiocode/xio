...
#REPOSTS
REPOSTS_WEIBO_INSERT_SQL = "insert ignore into `xio`.`tb_xweibo_info`(`wid`, `uid`, `text`, `source`, `created_at`, `retweeted_status_id`) values (%s , %s, %s, %s, %s, %s) "
